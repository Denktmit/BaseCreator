...
namespace BaseCreator_GUI.Helper.Commands {
  ...
  public class WPFCommandWindow : WPFCommand {
    ...
    protected Action<Window> _executeWindow;
    public override MethodInfo MethodInfo { get { return _executeWindow.Method; } }
    ...
    public WPFCommandWindow(Action<Window> execute, Func<bool> canExecute) {
      _commandType = WPFCommandType.NavigationTreeItem;
      this._executeWindow = execute;
      this._canExecute = canExecute;
    }
    public WPFCommandWindow(Action<Window> execute) : this(execute, null) { }
    ...
    protected override void SpecialisedExecute(object parameter) {
      switch (_commandType) {
        case WPFCommandType.Window:
          _executeWindow((Window)parameter);
          break;
        default:
